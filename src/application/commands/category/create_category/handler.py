...
from application.commands.category.create_category.dtos import CreateCategoryCommand, CreateCategoryCommandResponse
...
class CreateCategoryCommandHandler:
    ...
    async def run(self, data: CreateCategoryCommand) -> CreateCategoryCommandResponse:
        ...
        self._entity_saver.add_one(new_category)
        await self._transaction_db.commit()

        return CreateCategoryCommandResponse(
            category_id=new_category.oid
        )
